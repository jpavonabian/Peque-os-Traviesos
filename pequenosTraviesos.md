...
Las reglas de **Pequeños Traviesos** se basan en una simplificación de las reglas de Fate Acelerado. Son sencillas, no te preocupes. Y si una no convence, ¡quitadla!
...
- **Estilos (en qué destacas):** En lugar de atributos tradicionales, Fate Acelerado usa **seis estilos** que describen *cómo* actúa tu personaje:
  ...
  - **Cauto:** Actuar con precaución y paciencia. *(Ejemplo: Esconderse con cuidado para que la maestra no te vea.)*
...
- **Estrés y Consecuencias:** Representan los problemas temporales que sufren los personajes cuando las cosas no salen bien (como daño, cansancio o líos). En **Pequeños Traviesos**, al ser un juego ligero, normalmente **no hay heridas graves**, sino contratiempos cómicos (raspones, estar agotado, o que te atrapen los adultos). Cada personaje tiene un **medidor de Estrés** con **3 casillas**. Cuando recibes un impacto o consecuencia por fallar o por ser afectado por un enemigo, marca casillas de estrés:
  ...
  - Un **impacto leve** ocupa 1 casilla, un impacto moderado 2 y un impacto grave 3. (Si recibes por ejemplo 2 puntos de estrés, marca la casilla de valor 2; si recibes 3, marca la de 3; si recibes 4 o más, podrías marcar la de 3 y la de 1 juntas, por ejemplo, para absorber un total de 4).
  - Si no tienes casillas libres suficientes para absorber un impacto, tu personaje queda **fuera del juego** en esta escena (¡te han pillado, te rindes o necesitas un respiro!). Esto no es el fin de tu personaje: simplemente significa que momentáneamente estás a merced de la historia o de los oponentes en esa escena. En términos narrativos, quizás te han castigado a reflexionar a una esquina o te escondes hasta que pase el peligro porque tienes mucho miedo.

  Opcionalmente, puedes en lugar de quedar fuera de juego, aceptar **Consecuencias**: un aspecto negativo duradero que refleja un contratiempo mayor pero te mantiene en juego. Por ejemplo, *"Magullado y sucio"* (consecuencia leve, -2), *"Regañado y castigado"* (moderada, -4). Las consecuencias reducen el estrés recibido en esa cantidad pero añaden un nuevo aspecto que puede ser invocado por los oponentes o la historia. En este tipo de juego usar o no consecuencias queda a decisión del grupo; pueden estar guay si quereis jugar campañas largas donde los problemas trascienden una escena.

  Las casillas de Estrés **se vacían al final de cada escena**, siempre que tu personaje tenga un momento de descanso, calma o respiro. En términos narrativos, esto suele coincidir con el fin de una travesura, cuando cambia el escenario o cuando teneis un momento para respirar (por ejemplo, tras escapar, esconderos o cambiar de actividad).
...
- Quienes jugais podeis describir la situación inicial y los desafíos. Podeis turnaros para introducir problemas: p.ej., en tu turno puedes narrar qué obstáculo o travesura ocurre a continuación y los demás colaborar o ayudar. Podeis también obviarlo por completo y limitaros a tirar dados cuando sea necesario, dejando la historia fluir y consensuando las acciones y dificultades en grupo.
- Para determinar éxitos o fracasos imparciales sin DJ, apoyaos en las tiradas: si no hay oposición obvia, tirad contra una dificultad fija acordada (como se recomienda arriba). Si hay incertidumbre sobre las consecuencias, podeis usar una regla de destino: por ejemplo, tirar 1d6 – si sale 1-2 algo va mal, 3-4 ocurre algo neutro, 5-6 ocurre algo favorable inesperadamente.
...
**Descripción:** [Breve descripción física/personalidad]
